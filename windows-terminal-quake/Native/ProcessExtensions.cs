...
public static class ProcessExtensions
{
	...
	/// </summary>
	public static void SetAlwaysOnTop(this Process process, IRetry retry)
	{
		if (process == null) throw new ArgumentNullException(nameof(process));
	...
	public static void SetTransparency(this Process process, IRetry retry, int transparency)
	{
		if (process == null) throw new ArgumentNullException(nameof(process));
