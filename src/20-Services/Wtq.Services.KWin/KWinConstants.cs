...
public static class KWinConstants
{
	/// <summary>
...
//	Key_Camera				= 0x01100020, // "Akey to activate the camera shutter. On Windows Runtime, the environmentvariable QT_QPA_ENABLE_CAMERA_KEYS must be set to receive the event."
//	Key_CameraFocus				= 0x01100021, // "Akey to focus the camera. On Windows Runtime, the environment variableQT_QPA_ENABLE_CAMERA_KEYS must be set to receive the event."
