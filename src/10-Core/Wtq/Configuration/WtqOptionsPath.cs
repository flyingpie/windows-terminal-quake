...
//
// public sealed class WtqOptionsPath(string path)
// {
// 	public string Path { get; } = Guard.Against.NullOrWhiteSpace(path);
// }
//
// //
// // /// <summary>
// // /// Handles finding the path to the settings file, and creating one of one doesn't exist.
// // /// </summary>
// //
