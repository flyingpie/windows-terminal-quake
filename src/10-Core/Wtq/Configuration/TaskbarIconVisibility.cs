...
public enum TaskbarIconVisibility
{
	...
	/// <summary>
	/// <b>Never</b> show the taskbar icon.
	/// </summary>
	[Display(Name = "Always hidden")]
	AlwaysHidden,

	/// <summary>
	/// <b>Always</b> show the taskbar icon (note that this can look a bit weird when the app is toggled off).
	/// </summary>
	[Display(Name = "Always visible")]
	AlwaysVisible,

	/// <summary>
	/// Only show the taskbar icon when the app is toggled <b>on</b>.
	/// </summary>
